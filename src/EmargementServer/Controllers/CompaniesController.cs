...
using EmargementServer.Data;
using EmargementServer.Models;
using System.Diagnostics;

namespace EmargementServer.Controllers
{
    public class CompaniesController : Controller
    {
        private readonly EmServerDbContext _context;

        public CompaniesController(EmServerDbContext context)
        {
            _context = context;
        }
